...
known_image = face_recognition.load_image_file("face_recognition_test.jpg")
...
while True:
	...
	try:
		...
		if results:
			...
			img = cv.putText(img, 'Abhay Mathur', (30, 55), cv.FONT_HERSHEY_SIMPLEX, 1,
					(255,0,0), 2, cv.LINE_AA)
			print('Abhay Mathur Enter....')
			plt.imshow(img)
			plt.show()
			break
	except:
		img = cv.putText(frame, 'Not Abhay Mathur', (30, 55), cv.FONT_HERSHEY_SIMPLEX, 1,
				(255,0,0), 2, cv.LINE_AA)
